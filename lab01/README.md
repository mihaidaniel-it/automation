...
![Часть 1 скрипта](images/01_script_part1.png)
...
![Часть 2 скрипта](images/02_script_part2.png)
...
![Структура проекта](images/03_project_structure.png)
...
![Тест с директорией backups](images/04_run_example_backups.png)
...
![Тест с текущей директорией](images/05_run_example_default_dir.png)
